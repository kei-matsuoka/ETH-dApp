...
const App = () => {
  ...
  const contractAddress = "0x671496BDA001718Ef8262fcfEd5C850D68138BD1";
  ...
  useEffect(() => {
    ...
    const onNewWave = (from, timestamp, message, seed) => {
      console.log("NewWave", from, timestamp, message, seed);
